...
export default function HeroFeatures() {
  return (
    <>
    <div className="relative md:h-screen md:max-h-[950px] h-auto text-yellow-900">
        ...
        <div className="flex h-full flex-col items-center justify-between md:flex-row md:pb-24">
          ...
          <div className="relative order-1 min-h-[225px] min-w-[225px] overflow-hidden md:overflow-auto md:w-[860px] md:h-[860px] md:ml-[80px] md:mt-[50px]">
            <video
              ...
              src="/assets/learnDiffWayVideo.mp4"
            ></video>
          </div>

          <div className="max-w-3xl animate-hero-text-slide-up-fade sm:shrink-0 md:order-1 lg:pl-16">
          <h1 className="text-center md:text-left text-[4rem] md:text-7xl leading-[4.35rem] md:leading-[5rem] tracking-tight">
              Learning In
              <br />
              Different Way
            </h1>
            <p className="mb-8 mt-4 max-w-[30rem] text-center leading-7 md:text-left text-base md:text-[1.125rem] md:leading-[1.5] font-normal text-slate-700">
    ...
    <div className="relative z-20 md:h-screen md:max-h-[950px] h-auto text-yellow-900">
      <section className="mx-auto max-w-5xl px-6 md:h-screen md:max-h-[950px] md:max-w-7xl">
        <div className="flex h-full flex-col items-center justify-between md:flex-row md:pb-24">
          ...
          <div className="max-w-3xl sm:shrink-0 md:order-1 lg:pl-16">
          <h1 className="md:text-left text-[4rem] md:text-7xl leading-[4.35rem] md:leading-[5rem] tracking-tight">
              Learning In
              <br />
              Different Way
            </h1>
            <p className="sans mb-8 mt-4 max-w-[30rem] text-center leading-7 md:text-left text-base md:text-[1.125rem] md:leading-[1.5] text-slate-11 font-normal text-slate-700">
            The best way to reach humans instead of spam folders. Deliver transactional and marketing emails at scale.
            </p>
          </div>
          ...
          <div className="relative order-1 min-h-[225px] min-w-[225px] overflow-hidden md:overflow-auto md:w-[860px] md:h-[860px] md:ml-[80px] md:mt-[50px]">
            <video
              ...
              preload="none"
              className="absolute left-0 top-0 sm:h-[225px] sm:w-[225px] md:h-[860px] md:w-[860px]"
              src="/assets/onlineLibraryVideo.mp4"
            ></video>
          </div>
        ...
        <div className="flex h-full flex-col items-center justify-between md:flex-row md:pb-24">
          ...
          <div className="relative order-1 min-h-[225px] min-w-[225px] overflow-hidden md:overflow-auto md:w-[860px] md:h-[860px] md:ml-[80px] md:mt-[50px]">
            <video
              ...
              preload="none"
              className="absolute left-0 top-0 sm:h-[225px] sm:w-[225px] md:h-[860px] md:w-[860px]"
              src="/assets/learnFromInstructorVideo.mp4"
            ></video>
          </div>
        ...
        <div className="flex h-full flex-col items-center justify-between md:flex-row md:pb-24">
          ...
          <div className="relative order-1 min-h-[225px] min-w-[225px] overflow-hidden md:overflow-auto md:w-[860px] md:h-[860px] md:ml-[80px] md:mt-[50px]">
            <video
              ...
              preload="none"
              className="absolute left-0 top-0 sm:h-[225px] sm:w-[225px] md:h-[860px] md:w-[860px]"
              src="/assets/onlineStudyVideo.mp4"
            ></video>
          </div>
